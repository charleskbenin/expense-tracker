...
// in expense_tracker/test/dashboard/dashboard_repository_test.dart.
...
class MockDashboardRemoteDatasource extends _i1.Mock
  ...
  @override
  _i3.Future<List<_i4.IncomeModel>> fetchUserIncome() => (super.noSuchMethod(
        Invocation.method(
          #fetchUserIncome,
          [],
        ),
        returnValue:
            _i3.Future<List<_i4.IncomeModel>>.value(<_i4.IncomeModel>[]),
      ) as _i3.Future<List<_i4.IncomeModel>>);

  @override
  _i3.Future<Map<String, dynamic>> addIncome(
